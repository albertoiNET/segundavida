...
class StaticContractTests(unittest.TestCase):
    ...
    def test_client_contract_keeps_old_endpoints_and_uses_clean_routes(self):
        ...
        self.assertIn("CATALOG_RETRY_DELAYS_MS = Object.freeze([350, 1000])", app_source)
        self.assertIn("fresh: state.catalogNeedsRefresh || attempt > 0", app_source)
        self.assertIn("No hemos podido cargar los objetos. Reintentando…", app_source)
        self.assertIn("function waitForCatalogRetry", app_source)
        ...
        self.assertIn('image.loading = "lazy"', app_source)
