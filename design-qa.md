...
- Detail source visual: `/var/folders/8r/kmn758jj0h7cq06fx_44sb100000gp/T/codex-clipboard-62c69579-5684-4bdd-a35f-e57a016ff263.png`
- Detail implementation capture: `/private/tmp/segundavida-detail-implementation.png`
- Detail comparison input: `/private/tmp/segundavida-detail-comparison.png`
...
- On the detail view, only the media block breaks out to the viewport edges directly beneath the sticky header; the title, metadata, actions, and community panel remain in an inset content column.
- Detail rhythm gives the description more vertical breathing room and separates the primary “Me interesa” action from the metadata block.
...
8. Detail-view refinement made the image full-bleed below the header, removed its radius, and restored breathing room around the remaining content.
9. Detail rhythm refinement added space around the description and increased the CTA separation from the ficha metadata.
