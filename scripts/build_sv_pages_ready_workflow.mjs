...
const webhook = trigger({ type: 'n8n-nodes-base.webhook', version: 2.1, config: { name: 'Pages ready webhook', position: [-2016, 0], credentials: { httpHeaderAuth: newCredential('Segunda Vida Pages callback') }, parameters: { httpMethod: 'POST', path: 'segundavida/pages-ready', authentication: 'headerAuth', responseMode: 'responseNode', options: {} } } });
